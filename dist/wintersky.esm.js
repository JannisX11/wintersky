import { Object3D, Texture, NearestFilter, Vector3, Euler, Plane, PlaneBufferGeometry, Mesh, BufferAttribute, Quaternion, Line3, Sphere, ShaderMaterial, FaceColors, Vector2, DoubleSide, FrontSide, AdditiveBlending, NormalBlending, CubicBezierCurve, SplineCurve } from 'three';
...
class Emitter extends EventClass {
	...
	updateMaterial() {
		...
		this.material.side = (material === 'particles_blend' || material === 'particles_add') ? DoubleSide : FrontSide;
