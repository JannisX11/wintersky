(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('molangjs'), require('three'), require('tinycolor2')) :
	typeof define === 'function' && define.amd ? define(['molangjs', 'three', 'tinycolor2'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Wintersky = factory(global.Molang, global.THREE, global.tinycolor));
}(this, (function (Molang, THREE, tinycolor) { 'use strict';
	...
	Wintersky.Emitter = class {
		constructor(config, options = 0) {
			...
			this.space = new THREE__default['default'].Object3D();
		...
		updateMaterial() {
			...
			var tex = new THREE__default['default'].TextureLoader().load(url, function(a, b) {
				tex.magFilter = THREE__default['default'].NearestFilter;
				tex.minFilter = THREE__default['default'].NearestFilter;
		...
		add() {
			...
			if (this.emitter.space.parent) {
				if (!this.emitter.config.space_local_rotation) {
					this.position.applyQuaternion(this.emitter.space.getWorldQuaternion(new THREE__default['default'].Quaternion()));
				}
				if (!this.emitter.config.space_local_position) {
					let offset = this.emitter.space.getWorldPosition(new THREE__default['default'].Vector3());
