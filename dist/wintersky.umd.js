(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('molangjs'), require('three')) :
	typeof define === 'function' && define.amd ? define(['molangjs', 'three'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Wintersky = factory(global.Molang, global.THREE));
}(this, (function (Molang, THREE) { 'use strict';
	...
	*/
	...
	class Wintersky {
		constructor(config) {
			...
			this.object = new THREE__default['default'].Object3D();
			...
			this.group = new THREE__default['default'].Object3D();
		...
		calculate(input, variables, datatype) {
			...
			if (input instanceof Array) {
				...
				data = new THREE__default['default'].Color('#'+c);
			} else {
				data = getV(input);
			}
			return data;
	...
	Wintersky.Particle = class {
		...
		add() {
			...
			if (this.emitter.shape === 'box') {
				...
				this.position.applyEuler(THREE__default['default'].getRandomEuler());
			...
			if (dir == 'inwards' || dir == 'outwards') {
				...
				if (this.emitter.shape === 'point') {
					this.speed.set(1, 0, 0).applyEuler(THREE__default['default'].getRandomEuler());
				} else {
